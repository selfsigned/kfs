...
kbd_entry const *kbd_layout = KBD_DEFAULT_LAYOUT;
...
const kbd_entry layout_us_mode1[KBD_KEYS_END] = {
    ...
    [KBD_BACKSPACE] = {0, KBD_BACKSPACE, '\b'},
    [KBD_TAB] = {0, KBD_TAB, '\t'},
    ...
    [KBD_F8] = {0, KBD_F8},
    [KBD_F9] = {0, KBD_F9},
    [KBD_NUMLOCK] = {FLAG_TOGGLE, KBD_NUMLOCK},
    [KBD_F10] = {0, KBD_F10},
    [KBD_F11] = {0, KBD_F11},
    [KBD_F12] = {0, KBD_F12},
...
const kbd_entry layout_fr_mode1[KBD_KEYS_END] = {
    [KBD_ESCAPE] = {0, KBD_ESCAPE},
    // KEY  FLAG  CODE NORMAL SHIFT ALT
    [KBD_1] = {0, KBD_1, '&', '1', '1'},
    [KBD_2] = {0, KBD_2, 'e', '2', '~'}, // no CP437
    [KBD_3] = {0, KBD_3, '"', '3', '#'},
    [KBD_4] = {0, KBD_4, '\'', '4', '{'},
    [KBD_5] = {0, KBD_5, '(', '5', '['},
    [KBD_6] = {0, KBD_6, '-', '6', '|'},
    [KBD_7] = {0, KBD_7, 'e', '7', '`'}, // no CP437
    [KBD_8] = {0, KBD_8, '_', '8', '\\'},
    [KBD_9] = {0, KBD_9, 'c', '9', '^'}, // no CP437
    [KBD_0] = {0, KBD_0, 'a', '0', '@'}, // no CP437
    [KBD_DASH] = {0, KBD_DASH, ')', 0, ']'},
    [KBD_EQUAL] = {0, KBD_EQUAL, '=', '+', '}'},
    [KBD_BACKSPACE] = {0, KBD_BACKSPACE, '\b'},
    [KBD_TAB] = {0, KBD_TAB, '\t'},
    [KBD_Q] = {FLAG_CAPSLOCK, KBD_A, 'a', 'A'},
    [KBD_W] = {FLAG_CAPSLOCK, KBD_Z, 'z', 'Z'},
    [KBD_E] = {FLAG_CAPSLOCK, KBD_E, 'e', 'E'},
    [KBD_R] = {FLAG_CAPSLOCK, KBD_R, 'r', 'R'},
    [KBD_T] = {FLAG_CAPSLOCK, KBD_T, 't', 'T'},
    [KBD_Y] = {FLAG_CAPSLOCK, KBD_Y, 'y', 'Y'},
    ...
    [KBD_K] = {FLAG_CAPSLOCK, KBD_K, 'k', 'K'},
    [KBD_L] = {FLAG_CAPSLOCK, KBD_L, 'l', 'L'},
    [KBD_SEMICOLON] = {FLAG_CAPSLOCK, KBD_M, 'm', 'M'},
    [KBD_SINGLE_QUOTE] = {0, KBD_SINGLE_QUOTE, 'u', '%'}, // no CP437
    [KBD_BACKTICK] = {0, KBD_BACKTICK, '<', '>'},
    [KBD_LEFT_SHIFT] = {0, KBD_LEFT_SHIFT},
    [KBD_BACKSLASH] = {0, KBD_BACKSLASH, '*'}, // no CP437
    [KBD_Z] = {FLAG_CAPSLOCK, KBD_W, 'w', 'W'},
    [KBD_X] = {FLAG_CAPSLOCK, KBD_X, 'x', 'X'},
    [KBD_C] = {FLAG_CAPSLOCK, KBD_C, 'c', 'C'},
    [KBD_V] = {FLAG_CAPSLOCK, KBD_V, 'v', 'V'},
    [KBD_B] = {FLAG_CAPSLOCK, KBD_B, 'b', 'B'},
    [KBD_N] = {FLAG_CAPSLOCK, KBD_N, 'n', 'N'},
    [KBD_M] = {0, KBD_COMMA, ',', '?'},
    [KBD_COMMA] = {0, KBD_SEMICOLON, ';', '.'},
    [KBD_DOT] = {0, KBD_SLASH, ':', '/'},
    [KBD_SLASH] = {0, KBD_SLASH, '!'}, // no CP437
    [KBD_RIGHT_SHIFT] = {0, KBD_RIGHT_SHIFT},
    [KBD_KEYPAD_ASTERISK] = {0, KBD_KEYPAD_ASTERISK, '*', '*'},
    [KBD_LEFT_ALT] = {0, KBD_LEFT_ALT},
    [KBD_SPACE] = {0, KBD_SPACE, ' ', ' '},
...
const kbd_entry layout_colemak_mode1[KBD_KEYS_END] = {
    [KBD_ESCAPE] = {0, KBD_ESCAPE},
    // KEY  FLAG  CODE NORMAL SHIFT ALT
    [KBD_1] = {0, KBD_1, '1', '!', '1'},
    [KBD_2] = {0, KBD_2, '2', '@', '2'},
    ...
    [KBD_Q] = {FLAG_CAPSLOCK, KBD_Q, 'q', 'Q'},
    [KBD_W] = {FLAG_CAPSLOCK, KBD_W, 'w', 'W'},
    [KBD_E] = {FLAG_CAPSLOCK, KBD_F, 'f', 'F'},
    [KBD_R] = {FLAG_CAPSLOCK, KBD_P, 'p', 'P'},
    [KBD_T] = {FLAG_CAPSLOCK, KBD_G, 'g', 'G'},
    [KBD_Y] = {FLAG_CAPSLOCK, KBD_J, 'j', 'J'},
    [KBD_U] = {FLAG_CAPSLOCK, KBD_L, 'l', 'L'},
    [KBD_I] = {FLAG_CAPSLOCK, KBD_U, 'u', 'U'},
    [KBD_O] = {FLAG_CAPSLOCK, KBD_Y, 'y', 'Y'},
    [KBD_P] = {0, KBD_SEMICOLON, ';', ':'},
    [KBD_OPENING_BRACKET] = {0, KBD_OPENING_BRACKET, '[', '{'},
    [KBD_CLOSING_BRACKET] = {0, KBD_CLOSING_BRACKET, ']', '}'},
    [KBD_ENTER] = {0, KBD_ENTER, '\n'},
    [KBD_LEFT_CTRL] = {0, KBD_LEFT_CTRL},
    [KBD_A] = {FLAG_CAPSLOCK, KBD_A, 'a', 'A'},
    [KBD_S] = {FLAG_CAPSLOCK, KBD_R, 'r', 'R'},
    [KBD_D] = {FLAG_CAPSLOCK, KBD_S, 's', 'S'},
    [KBD_F] = {FLAG_CAPSLOCK, KBD_T, 't', 'T'},
    [KBD_G] = {FLAG_CAPSLOCK, KBD_D, 'd', 'D'},
    [KBD_H] = {FLAG_CAPSLOCK, KBD_H, 'h', 'H'},
    [KBD_J] = {FLAG_CAPSLOCK, KBD_N, 'n', 'N'},
    [KBD_K] = {FLAG_CAPSLOCK, KBD_E, 'e', 'E'},
    [KBD_L] = {FLAG_CAPSLOCK, KBD_I, 'i', 'I'},
    [KBD_SEMICOLON] = {FLAG_CAPSLOCK, KBD_O, 'o', 'O'},
    [KBD_SINGLE_QUOTE] = {0, KBD_SINGLE_QUOTE, '\'', '\"'},
    [KBD_BACKTICK] = {0, KBD_BACKTICK, '`', '~'},
    [KBD_LEFT_SHIFT] = {0, KBD_LEFT_SHIFT},
    [KBD_BACKSLASH] = {0, KBD_BACKSLASH, '\\', '|'},
...
const struct kbd_layout_info kbd_available_layouts[] = {
    {layout_us_mode1, "us"},
    {layout_fr_mode1, "fr"},
    {layout_colemak_mode1, "colemak"},
    {},
};
