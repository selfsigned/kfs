...
void screen_lorem_ipsum(uint8_t screen_nbr, uint8_t ipsum_nbr) {
  ...
  for (; ipsum_nbr; --ipsum_nbr) {
    vga_printf(
        (vga_info){.screen = screen_nbr, .nowrapchar = true},
        ...
        "adipiscing nisl, ac euismod nibh nisl eu lectus. Fusce vulputate sem "
        "at "
        "sapien. Vivamus leo. Aliquam euismod libero eu enim. Nulla nec felis "
